...
seed = 9  # 设置随机数
clf = KMeans(n_clusters=20, random_state=seed)  # 聚类
clf.fit(np_data[:, 1:])  # 拟合模型
# print(clf.cluster_centers_)  # 查看KMeans聚类后的10个质心点的值。
print(clf.inertia_)
# print(clf.labels_)  # 对原数据表进行类别标记

seed = 9  # 设置随机数
clf = KMeans(n_clusters=50, random_state=seed)  # 聚类
clf.fit(np_data[:, 1:])  # 拟合模型
# print(clf.cluster_centers_)  # 查看KMeans聚类后的10个质心点的值。
print(clf.inertia_)
# print(clf.labels_)  # 对原数据表进行类别标记
...
seed = 9  # 设置随机数
clf = KMeans(n_clusters=100, random_state=seed)  # 聚类
clf.fit(np_data[:, 1:])  # 拟合模型
# print(clf.cluster_centers_)  # 查看KMeans聚类后的10个质心点的值。
print(clf.inertia_)
# print(clf.labels_)  # 对原数据表进行类别标记
...
seed = 9  # 设置随机数
clf = KMeans(n_clusters=10, random_state=seed)  # 聚类
clf.fit(np_data[:, 1:])  # 拟合模型
# print(clf.cluster_centers_)  # 查看KMeans聚类后的10个质心点的值。
print(clf.inertia_)
# print(clf.labels_)  # 对原数据表进行类别标记
